...
P_hot_in = 90#Bar
P_cold_in = 210 #Bar
m_channel = 1e-3# channel mass flow rate, Kg/sec
##################################
# Geometric Inputs
t = 1#mm
w = 1#mm
...
hot_fluid = 'co2'
cold_fluid = 'co2'
k_solid =  380# w/mk-Copper at 350 Celsius
...
a =10 # number of nodes in x direction(direction of flow)
b_ch = 2 # pair of hot and cold channels along height (Y direction) - 1 pair of channels => b_ch =1
c_ch = 2 # no. of channels along width (Z direction) - one channel means c_ch = 1
